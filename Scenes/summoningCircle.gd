...
func _ready():
	set_ui_elements($Sprite2D/VBoxContainer/HBoxContainer3/IngredientDisplayPanel, $Sprite2D/VBoxContainer/HBoxContainer3/IngredientDisplayPanel2, $Sprite2D/VBoxContainer/HBoxContainer3/IngredientDisplayPanel3, $Craft, $Cancel, $Notification)
	recipes = {
